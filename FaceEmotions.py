...
#       Eye-Position    Eyes-Open   Pupil-Position      Mouth-Position      Happy-Mouth     EyeBrow-Position    EyeBrpw-Enabled
emotions = {
    ...
    "lisening": [pg.Vector2(-200, -40), 1, pg.Vector2(-170, -60), pg.Vector2(0, 30), True, pg.Vector2(-100, -120), 0],
}
            ...
            if event.type == pg.KEYDOWN:
                match event.key:
                    case pg.K_1:
                        changeEmotion("idle")
                    case pg.K_2:
                        changeEmotion("lisening")
                    case pg.K_3:
                        changeEmotion("sad")
                    case pg.K_4:
                        changeEmotion("angry")
    button.listen(pg.event.get())

    fillColor = (37, 58, 55)
    angryColor = (110, 39, 39)

    screen.fill(fillColor if not currentEmotion == "angry" else angryColor)
